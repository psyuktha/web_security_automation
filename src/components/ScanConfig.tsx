...
export const ScanConfig = ({ onStartScan, isScanning }: ScanConfigProps) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, sqlInjection: checked as boolean })
                }
                disabled={isScanning}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, xss: checked as boolean })
                }
                disabled={isScanning}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, commandInjection: checked as boolean })
                }
                disabled={isScanning}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, fileUpload: checked as boolean })
                }
                disabled={isScanning}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, csrf: checked as boolean })
                }
                disabled={isScanning}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAttackTypes({ ...attackTypes, authBypass: checked as boolean })
                }
                disabled={isScanning}
              />
