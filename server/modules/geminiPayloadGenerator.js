...
/**
 * Fallback benign XSS payloads for testing reflection
 */
export const getFallbackXSSPayloads = () => {
  return [
    "<script>console.log('xss-test-1')</script>",
    "\"><svg/onload=console.log('xss-test-2')>",
    "javascript:console.log('xss-test-3')",
    "<img src=x onerror=console.log('xss-test-4')>",
    "'\";console.log('xss-test-5');//"
  ];
};
